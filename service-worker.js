...
const CACHE_VERSION = 'ef-2609051827';
...
const PRECACHE = [
  ...
  '/src/js/shortfall.js', '/src/js/music.js', '/src/js/pathfind.js', '/src/js/farmer.js', '/src/js/hands.js', '/src/js/mapview-iso.js', '/src/js/main.js', '/src/js/pwa-install.js',
