...
- 🔒 **中文要写成 Chris 的口吻，不是我的。**（2026-08-24 他直接说：「中文表达要符合我的口吻」。）
  对着他自己写的那几句校准 ——「东超每天都有很多订单，**请**按订单备货」
  「店里的新鲜菜和水果**都可在**东方农场自己种」「按订单供货给东超」：
  **平实的完整句、书面但不端着、直说事情**。
  我一路在往**口语和文艺**上飘，反复被抓：
  - ❌ 口语尾巴：忘了也不要紧 / 照着备货就行 / 不用你守着 / 来了就有得领 /
    五分钟的事 / 高一截 / 天天花 / 掏钱包 / 慢慢攒 / 冒出订单
  - ❌ 拟人和比喻：「菜一直等着你」
  - ❌ 破折号当口语停顿（我用得最多的一个毛病）、句中省略号
  - ✅ 换成：完整句 + 平实连接词（另外 / 可以 / 完成后 / 等等 / 也）+ 把量词写全
    （「一共 30 款」不是「30 款」，「每秒 2.2 格」不是「2.2 格／秒」）

  🔒 **标题和正文是两把尺子，别用同一把量**（2026-08-24 他逐条给了标题原字才看出来）：
  - **标题＝东西的名字**，四到六个字，名词性。他给的：农场车辆 / 农场厨房 /
    节日活动 / 建设农场 / 天天串门 / 每日签到有奖。
    我写的全是「一句话」：买车也可以开 / 做成菜再卖 / 过我们自己的节 /
    建设自己的农场 / 到街坊家串门 / 每天都有可以领的 —— 总要塞进动词和修饰。
  - **正文＝完整句**，该有的连词都有，像跟人说话（这条不变）。

  ⚠️ **别把口语量词也当成毛病删掉**（我 2026-08-24 矫枉过正过一次）：
  「摆个菜摊」是我原来写的，我嫌「个」口语改成「自己摆菜摊」，**他又改回了
  「摆个菜摊」**。他排斥的是**口语的尾巴**（不要紧 / 就行 / 有得领 / 的事），
  不是量词。这两件事我混成过一件。

  ⚠️ 这条管**所有玩家看得见的中文**：怎么玩、卡片文案、toast、弹窗，一视同仁。
  ⚠️ **英文侧目前零信号** —— Chris 从没评过英文，别假设现在这套英文他认可。
- **说顾客能得到什么，不说我们做了什么。** 2026-08-23 Chris 看菜那张：
  「『种的都是店里买的菜』这句话是没有意义的，不要再用这种对客人没有价值的话。」
  他给的替换是「**店里的新鲜菜和水果都可在东方农场自己种**」——
  同一件事，我那句是**陈述我们的设计**（我们把货架搬进了游戏），
  他那句把**动作交给顾客**（你可以自己种）。判断法：
  这句话的主语是不是「你」？不是的话，多半是在自说自话。
- **不替自己辩护，不回答没人问的疑问。** 2026-08-23 街坊那张我写的副文是
  「邻居都是真的会员，**不是假人**」，Chris：「这样的废话不要讲。」
  「不是假人」是**我们**的骄傲（别家造假人我们没有），不是顾客的疑问 ——
  他压根没想过这事，说了反而替他种下这个念头。同一批还改掉两处**重复标题**的
  （标题已说「各得 200」，副文又说一遍「你得 200 他也得 200」）。
  落笔前对每句话问：这句给了新东西吗？没有就删。
...
- **开车（2026-08-20）**：点农场任意空地，人绕开障碍走过去（`src/js/pathfind.js`
  ...
  建造模式与拜访别人农场时一律开不了。**要走远路人自己去开车，到地头下车干活**
  —— 判据是「目的地比车还远」（Chris 2026-08-21 定，⚠️ **1.3 倍省时门槛已废**：
  触发太少，而且开车本身就是乐趣）。`MIN_DRIVE_DIST=3` 以内直接走（上下车动画
  比走过去还久）；一批活干到一半、下一块地隔 `REDRIVE_DIST=4` 格以上会回去开车。
  除此之外
